...
(function () {
    ...
    $(".laypage_btn").on('click',function(){
        var evey = $(".evey-page").val();
        var action = $('.sync-html .page_bind form').attr('action');
        var inputPage = parseInt($(this).siblings('.laypage_skip').val());
        var allPage = $('.sync-html .page_bind form').attr('data-all');
