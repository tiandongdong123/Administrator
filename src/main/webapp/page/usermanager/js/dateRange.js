...
function pickerDateRange(inputId, options) {
    ...
    var defaults = {
        ...
        minValidDate: '966528000', //最小可用时间，控制日期选择器的可选力度
    ...
    var wrapper = {
        gri: [
            ...
            '<input type="text" class="gri_dateRangeInput test_data dateRangeInputSingle" name="' + this.startDateId + '" id="' + this.startDateId + '" value="' + this.mOpts.startDate + '"  />',
            '<span id="' + this.mOpts.joinLineId + '"> - </span>',
            '<input type="text" class="gri_dateRangeInput test_data dateRangeInputCompare" name="' + this.endDateId + '" id="' + this.endDateId + '" value="' + this.mOpts.endDate + '"  /><br />',
            '</div>',
            '<div class="gri_dateRangeInput" id="' + this.dateRangeCompareDiv + '">',
            '<input type="text" class="gri_dateRangeInput test_data dateRangeInputSingle" name="' + this.startCompareDateId + '" id="' + this.startCompareDateId + '" value="' + this.mOpts.startCompareDate + '"  />',
            '<span class="' + this.mOpts.joinLineId + '"> - </span>',
            '<input type="text" class="gri_dateRangeInput test_data dateRangeInputCompare" name="' + this.endCompareDateId + '" id="' + this.endCompareDateId + '" value="' + this.mOpts.endCompareDate + '"  />',
            '</div>',
...
pickerDateRange.prototype.fillDate = function (year, month, index) {
    ...
    if (isTaTheme) {
        ...
        if (0 == index) {
            ...
            $(td).append('<a href="javascript:void(0);" id="' + this.nextYear + '" class="gri_dateRangeNextYear"><span>next</span></a>');
            $(td).append('<a href="javascript:void(0);" id="' + this.nextMonth + '" class="gri_dateRangeNextMonth"><span>next</span></a>');
        }
        // 如果是第一个月的日期，则加上上一个月的链接
        if (index + 1 == this.mOpts.calendars) {

            $(td).append('<a href="javascript:void(0);" id="' + this.preYear + '" class="gri_dateRangePreYear"><span>pre</span></a>');
