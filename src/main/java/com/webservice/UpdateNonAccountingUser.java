 ...
 *         &lt;element name="UserState" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlType(name = "", propOrder = { "username", "startTime", "endTime", "rdptauth", "onlines",
		"copys", "prints", "sigprint", "ip", "cls", "unit", "userState", "token" })
@XmlRootElement(name = "UpdateNonAccountingUser")
public class UpdateNonAccountingUser {
