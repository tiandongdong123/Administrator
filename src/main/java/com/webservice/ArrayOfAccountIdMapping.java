...
/**
 * <p>ArrayOfAccountIdMapping complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
...
@XmlType(name = "ArrayOfAccountIdMapping", propOrder = {
    "accountIdMapping"
})
public class ArrayOfAccountIdMapping {
     ...
     * This is why there is not a <CODE>set</CODE> method for the accountIdMapping property.
     * 
     * <p>
