...
public class SourceAnalysisLinkHostHourly {
	
	private Integer type; //指标类型（1,2,3...）
	private String link_host; //外部链接域名
	...
	public String toString() {
		return "SourceAnalysisLinkHostHourly [type=" + type + ", link_host="
				+ link_host + ", date=" + date + ", hour=" + hour
