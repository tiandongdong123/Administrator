...
public class SourceAnalysisSearchEngineDaily {
	...
	public String toString() {
		return "SourceAnalysisSearchEngineDaily [type=" + type
				+ ", engine_name=" + engine_name + ", date=" + date
				+ ", numbers=" + numbers + ", sum=" + sum + ", sum1=" + sum1
