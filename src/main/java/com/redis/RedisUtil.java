...
public class RedisUtil {
	...
	static {
		if (pool == null) {
			...
			pool = new JedisPool(config, ip, prot, 500);
		}
	}
	 ...
	 * @param prot 端口
	 */
	public static void RedisUtil(JedisPoolConfig config ,String ip, int prot){
		if (pool == null) {
	 ...
	 * @param timeout 超时时间
	 */
	public static void RedisUtil(JedisPoolConfig config ,String ip, int prot ,int timeout){
		if (pool == null) {
	...
	public static void main(String[] args) {
		System.out.println(RedisUtil.get("CLCDic",1));
